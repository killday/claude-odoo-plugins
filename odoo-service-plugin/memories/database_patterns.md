...
```powershell
# Create backup script: /path/to/odoo\backup_all.ps1
$timestamp = Get-Date -Format "yyyyMMdd_HHmmss"
$backupDir = "/path/to/odoo\backups"
...
schtasks /create /tn "OdooBackup" /tr "powershell -File /path/to/odoo\backup_all.ps1" /sc daily /st 02:00
```
